...
# Risk limits
MAX_DAILY_LOSS_USD = _env_float("MAX_DAILY_LOSS_USD", 20.00)
...
ML_OVERRIDE_MAX_PER_SESSION = _env_int("ML_OVERRIDE_MAX_PER_SESSION", 999999)
...
# ML confidence aggressive sizing (compounds with score-based boost)
ML_CONF_STRONG_THRESHOLD = _env_float("ML_CONF_STRONG_THRESHOLD", 0.75)
ML_CONF_VERY_STRONG_THRESHOLD = _env_float("ML_CONF_VERY_STRONG_THRESHOLD", 0.88)
ML_CONF_STRONG_LOT_MULT = _env_float("ML_CONF_STRONG_LOT_MULT", 2.0)
ML_CONF_VERY_STRONG_LOT_MULT = _env_float("ML_CONF_VERY_STRONG_LOT_MULT", 3.0)
