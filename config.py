...
SIGNAL_ENTRY_THRESHOLD = _env_float("SIGNAL_ENTRY_THRESHOLD", 0.85)
SL_ATR_MULTIPLIER = _env_float("SL_ATR_MULTIPLIER", 2.0)
TP1_MULTIPLIER = _env_float("TP1_MULTIPLIER", 1.0)
TP2_MULTIPLIER = _env_float("TP2_MULTIPLIER", 2.0)
TP3_MULTIPLIER = _env_float("TP3_MULTIPLIER", 3.5)
