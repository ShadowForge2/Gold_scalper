...
from dukascopy_python.instruments import (
    ...
    INSTRUMENT_CMD_ENERGY_GAS_CMD_USD, INSTRUMENT_CMD_METALS_COPPER_CMD_USD,
    INSTRUMENT_CMD_METALS_XPT_CMD_USD,
    INSTRUMENT_IDX_AMERICA_E_NQ_100, INSTRUMENT_IDX_AMERICA_E_SANDP_500,
    INSTRUMENT_IDX_AMERICA_E_D_J_IND,
    INSTRUMENT_IDX_ASIA_E_N225JAP, INSTRUMENT_IDX_EUROPE_E_DAAX,
)
...
SYMBOL_MAP = {
    ...
    "PLATINUM": INSTRUMENT_CMD_METALS_XPT_CMD_USD,
    "EURUSD": INSTRUMENT_FX_MAJORS_EUR_USD,
    "US100": INSTRUMENT_IDX_AMERICA_E_NQ_100,
    "NASDAQ": INSTRUMENT_IDX_AMERICA_E_NQ_100,
